...
short_window = 20
long_window = 250
trade_amount = 500 # Quantidade a ser negociada
running = True
buy_threshold = 5
...
price = float(client.get_symbol_ticker(symbol="SHIBUSDT")["price"])  # Preço atual
...
while running:
    ...
    if df is not None:
        ...
        print(f"✅ Valor mínimo da ordem para SHIB/USDT: {notional_min} USDT")
